...
export const WELL_TEST_CATALOG = {
  ...
  radon_in_air: {
    ...
    cost_low: 15,
    cost_high: 30,
    why: 'Radon is the second leading cause of lung cancer in the United States and it is completely invisible without a test. EPA zones predict county averages, not houses — homes in low-predicted counties still test high, and neighbours can differ. The test is a cheap cardboard kit you leave in the lowest lived-in level for a few days and mail in.',
